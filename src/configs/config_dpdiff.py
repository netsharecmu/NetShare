...
# DG-emulab: DP pretrain DIFF: UGR16
import os
...
config = {
	"scheduler_config": {
        "result_root_folder": "../results/results_sigcomm2022_dpdiff",
    ...
    "test_config": [
        {
            ...
            # "restore": [False],
            "pretrain_dir": ["../results/results_sigcomm2022_public/public/cidds/split-multiepoch_dep_v2,epochid-0,maxFlowLen-100,Norm-ZERO_ONE,vecSize-10,df2epochs-fixed_time,interarrival-True,fullIPHdr-False,encodeIP-False/iteration-400000,run-0,sample_len-1,pretrain_non_dp-False,pretrain_non_dp_reduce_time-None,pretrain_dp-False,dp_noise_multiplier-None,dp_l2_norm_clip-None/checkpoint/iteration_id-74999"],
...

        {
            ...
            # fine-tuning/pretrain
            # "restore": [False],
            "pretrain_dir": ["../results/results_sigcomm2022_public/public/dc/split-multiepoch_dep_v2,epochid-0,maxFlowLen-5000,Norm-ZERO_ONE,vecSize-10,df2epochs-fixed_time,interarrival-True,fullIPHdr-True,encodeIP-False/iteration-80000,run-0,sample_len-10,pretrain_non_dp-False,pretrain_non_dp_reduce_time-None,pretrain_dp-False,dp_noise_multiplier-None,dp_l2_norm_clip-None/checkpoint/iteration_id-9999"],
