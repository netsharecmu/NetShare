    ...
    "test_config": [
        {
            ...
            # "restore": [False],
            "pretrain_dir": ["../results/results_test_public/public/ugr16/split-multiepoch_dep_v2,epochid-0,maxFlowLen-100,Norm-ZERO_ONE,vecSize-10,df2epochs-fixed_time,interarrival-True,fullIPHdr-False,encodeIP-False/iteration-40,run-0,sample_len-1,pretrain_non_dp-False,pretrain_non_dp_reduce_time-None,pretrain_dp-False,dp_noise_multiplier-None,dp_l2_norm_clip-None,pretrain_dir-None/checkpoint/iteration_id-39"],
        }
