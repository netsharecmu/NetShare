...
def normalize_files_format(input_dir: str, target_dir: str, config: dict) -> None:
    """
    This is the builder function for the files format normalizer.
    """
    format_normalizer_config = config.get("pre_process", {}).get("format_normalizer", {})
    normalizer_type = config.get("dataset_type") or format_normalizer_config.get("dataset_type") or "csv"
