...
from netshare.utils.paths import get_model_folder
...
def _load_config() -> List[Config]:
    config_pre_expand = Config(
        {
            ...
            **get_config("learn", default_value={}),
    ...
    n_valid_chunks = 0
    for dataset_folder in learn_api.get_all_chunks_dirs():
    ...
    if generation_flag:
        for config_group in config_group_list:
            ...
            eval_root_folder = os.path.join(
                generate_api.get_raw_generated_data_dir(),
